...
| Runtime | 249 ms |
| Memory | 273.2 MB |
| Submission ID | 2150100095 |
| Solved On | 22 Sep 2026 |
...
| [Minimum Sum of Values by Dividing Array](https://leetcode.com/problems/minimum-sum-of-values-by-dividing-array/) | 🔴 Hard |
...
|----------|---------|--------|------|
| C++ | 249 ms | 273.2 MB | [solution.cpp](./solution.cpp) |
