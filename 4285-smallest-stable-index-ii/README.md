...
| Runtime | 7 ms |
| Memory | 202.6 MB |
| Submission ID | 2132009621 |
| Solved On | 05 Sep 2026 |
...
1. Precompute prefix maximums in an array <code>prefMax</code>, where <code>prefMax[i]</code> is the maximum of <code>nums[0..i]</code>
2. Precompute suffix minimums in an array <code>suffMin</code>, where <code>suffMin[i]</code> is the minimum of <code>nums[i..n-1]</code>
3. For each index <code>i</code>, compute the instability score as <code>prefMax[i] - suffMin[i]</code>
4. Return the smallest index where the instability score is <code><= k</code>. If no such index exists, return <code>-1</code>
...
|----------|---------|--------|------|
| C++ | 7 ms | 202.6 MB | [solution.cpp](./solution.cpp) |
