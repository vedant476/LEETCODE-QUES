# 4271. Find the Degree of Each Vertex
...
1. The degree of node <code>i</code> is the sum of row <code>i</code> in the matrix
...
|----------|---------|--------|------|
| C++ | 0 ms | 54.6 MB | [solution.cpp](./solution.cpp) |
