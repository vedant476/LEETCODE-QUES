...
| Runtime | 0 ms |
| Memory | 43.6 MB |
| Submission ID | 2032118286 |
| Solved On | 14 Jun 2026 |
...
1. For each word, sum character weights using <code>weights[c - 'a']</code>
2. Take the sum modulo <code>26</code>
3. Map the value to a character using reverse order: <code>char = 'z' - value</code>
...
|----------|---------|--------|------|
| C++ | 0 ms | 43.6 MB | [solution.cpp](./solution.cpp) |
