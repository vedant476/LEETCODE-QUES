...
| Runtime | 91 ms |
| Memory | 106.5 MB |
| Submission ID | 2040233773 |
| Solved On | 21 Jun 2026 |
...
| Problem | Difficulty |
|---------|------------|
| [Find Maximum Value in a Constrained Sequence](https://leetcode.com/problems/find-maximum-value-in-a-constrained-sequence/) | 🟡 Medium |
...
|----------|---------|--------|------|
| C++ | 91 ms | 106.5 MB | [solution.cpp](./solution.cpp) |
